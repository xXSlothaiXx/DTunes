...
class PlayerPage extends StatefulWidget {
  ...
  PlayerPage({Key key, @required this.pk}) : super(key: key);


  @override
  _PlayerPageState createState() => _PlayerPageState(pk);
}
...
class _PlayerPageState extends State<PlayerPage> {
  ...
  Future<String> getSong() async {
    ...
    http.Response response = await http.get(
        Uri.encodeFull("$network/dtunes/songs/song/$pk/?format=json"),
        headers: {
